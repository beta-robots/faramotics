...
const double ENSENSO_N35_APERTURE_HORIZONTAL = 0.4973119; 
const double ENSENSO_N35_APERTURE_VERTICAL =   0.4259958;
...
const double ENSENSO_N35_MIN_RANGE = 800;//150.; //in mm
